...
(function ($) {
  $('#galeria .imagen img ').wrap('<a data-open="modalGaleria">');
})(jQuery);

jquery__WEBPACK_IMPORTED_MODULE_0___default()('#galeria a').on('click', function () {
  // busca la imagen con un click y la selecciona y arriba le pone la clase
  var imagen = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find('img').attr('src');
  var imagenSeleccionada = imagen.split('img');
  var UrlCompleta = imagenSeleccionada[0] + 'img' + imagenSeleccionada[1];
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#imagenContenedor').attr('src', UrlCompleta);
});
...
module.exports = __webpack_require__(/*! D:\Estudios\Curso XY grid foundation 6 - activo\spahotel\src\assets\js\app.js */"./src/assets/js/app.js");
